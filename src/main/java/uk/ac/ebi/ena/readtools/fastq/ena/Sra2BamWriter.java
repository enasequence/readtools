 ...
 */
public class Sra2BamWriter implements ReadWriter<PairedRead, Spot> {
    ...
    public Sra2BamWriter(QualityNormalizer qualityNormalizer, String sampleName, String outputFilePath,
