...
public class MultiFastqOutputter {
	...
	public MultiFastqOutputter(OutputStream[] streams, OutputStream cacheOverFlowStream, SAMFileHeader header) {
	...
	public void writeRead(byte[] name, int flags, byte[] bases, byte[] scores) {
		FastqRead read = new FastqRead(bases.length, name, true,
