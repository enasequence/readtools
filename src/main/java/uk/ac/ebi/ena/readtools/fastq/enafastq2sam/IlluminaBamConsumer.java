 ...
 */
public class IlluminaBamConsumer implements DataConsumer<IlluminaSpot, Object> {
    ...
    private final ILLUMINA_SETTINGS type;
    ...
    public IlluminaBamConsumer(ILLUMINA_SETTINGS type, String sampleName, String outputFilePath) {
        this.type = type;
    ...
    public void consume(IlluminaSpot iSpot) throws DataConsumerException {
        ...
        } catch (QualityNormalizer.QualityNormaizationException ex) {
            isOk = false;
            ex.printStackTrace();
            throw new RuntimeException( "FATAL: unable to normalize quality: " + iSpot.quals, ex );
    ...
    @Override
    public void setConsumer(DataConsumer<Object, ?> dataConsumer) { }
    ...
    private SAMRecord createSamRecord(boolean paired, String baseName, String read, String qualities)
            throws QualityNormalizer.QualityNormaizationException {

        final byte[] normalizedQualities = type.getNormalizer().normalize(qualities);
