 ...
 * <p>"%[precision]s"
 *
 * <p>"%s", expected at the end of the pattern or the last formatting notation.
 *
 * <p>The id supplied in the argument will be trimmed from the left so that the last %s notation
 * will receive the remainder of the id.
 *
 * <p>For example: A pattern "anything/%2s/%3s/%s" formatted for id 0123456789 will result in
 * "anything/01/234/56789"
 *
 * @author vadim
 */
