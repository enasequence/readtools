...
public class PairedFastqReadsValidator extends FastqReadsValidator {
    ...
    */
    ...
    private static final Pattern CASAVA_LIKE_EXCLUDE_REGEXP = Pattern.compile(
    ...
    private String getCasavaReadNameWithoutIndex(String readName, long readIndex) throws ReadsValidationException {
    ...
    private String getCasavaReadIndex(String readName, long readIndex) throws ReadsValidationException {
        Matcher matcher = P_CASAVA_18_NAME.matcher(readName);
        if (!matcher.matches()) {
            throw new ReadsValidationException(
                    String.format("Line [%s] does not match %s regexp", readName, ReadStyle.CASAVA18),
