...
public class EnaFastq2SamTest {
    @Test
    public void testCorrectUnpaired() throws IOException, DataProducerException, DataConsumerException, NoSuchMethodException {
        EnaFastq2Sam.Params params = new EnaFastq2Sam.Params();
        params.quality_type = ILLUMINA_SETTINGS.SANGER.name();
        ...
        params.files = Arrays.asList(
                EnaFastq2SamTest.class.getClassLoader().getResource("fastq_spots_correct.txt").getFile());

        new EnaFastq2Sam().create(params);
    ...
    public void testCorrectPairedWithUnpaired() throws IOException, DataProducerException, DataConsumerException, NoSuchMethodException {
        File inpFile1 = new File(EnaFastq2SamTest.class.getClassLoader().getResource("fastq_spots_correct_paired_with_unpaired_1.txt").getFile());
        File inpFile2 = new File(EnaFastq2SamTest.class.getClassLoader().getResource("fastq_spots_correct_paired_with_unpaired_2.txt").getFile());
